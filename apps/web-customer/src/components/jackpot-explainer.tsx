  ...
  return (
    <section className="my-16 overflow-hidden">
      ...
      <Container size="lg" className="max-w-[1500px]">
        <div
          className="relative ml-[calc(50%-50vw)] w-[calc(100vw-2.5rem)] max-w-[1220px] overflow-hidden rounded-r-[36px] border border-[#A8E368]/35 bg-[#4E8F01] py-8 pr-8 pl-12 text-white shadow-[0_28px_80px_rgba(78,143,1,0.24)] sm:w-[calc(100vw-4rem)] sm:py-10 sm:pr-10 sm:pl-16 lg:w-[calc(100vw-10rem)] lg:pl-20 xl:w-[calc(100vw-14rem)] 2xl:w-[1180px]"
        ...
        >
          ...
          <div className="relative grid grid-cols-1 items-center gap-10 lg:grid-cols-[1fr_300px]">
            <div>
              <div className="mb-5 inline-flex items-center gap-2 rounded-sm bg-[#A8E368] px-3 py-1.5 text-xs font-black uppercase tracking-[0.14em] text-navy-950">
              ...
              <h2 className="font-display text-4xl font-black leading-[1.05] tracking-[-0.04em] text-white sm:text-5xl">
                ...
                <span className="text-[#A8E368]">1 free</span> Saturday jackpot entry.
              </h2>
            ...
            <div className="relative rounded-3xl border border-white/15 bg-white/10 p-4 backdrop-blur">
              <div className="mb-4 flex items-center justify-between">
                <p className="text-[11px] font-black uppercase tracking-[0.14em] text-[#A8E368]">
                  Ticket stack
                </p>
                <ArrowRight className="h-5 w-5 text-[#A8E368]" />
              </div>
              ...
              <div className="grid grid-cols-5 gap-2">
                {Array.from({ length: 10 }).map((_, i) => (
                  ...
                  >
                    <Star className="h-3.5 w-3.5 fill-[#A8E368] text-[#A8E368]" />
              ...
              <div className="mt-5 rounded-2xl bg-[#A8E368] px-5 py-4 text-navy-950">
                <p className="text-[11px] font-black uppercase tracking-[0.14em] text-[#4E8F01]">
                  Reward
                </p>
                <p className="mt-1 font-display text-2xl font-black tracking-[-0.04em]">
                  1 Free Jackpot Entry
                </p>
                <p className="mt-1 text-sm font-bold text-navy-950/65">
