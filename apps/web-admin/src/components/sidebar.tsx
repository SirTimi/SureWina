...
export function Sidebar() {
  ...
  return (
    <aside className="hidden h-screen w-[260px] shrink-0 flex-col border-r border-white/5 bg-[#1A1816] text-white lg:flex">
              ...
              {group.items.map((item) => {
                ...
                return (
                  <Link
                    ...
                    className={
                      active
                        ? 'flex items-center gap-3 rounded-lg bg-navy-800 px-3 py-2 text-sm font-bold text-white shadow-[0_8px_22px_rgba(78,143,1,0.35)]'
