    ...
    items: [
      {
        ...
        href: '/wallets',
        icon: Wallet,
        help: 'Customer and agent wallets, balances, funding, and ledger activity',
        permission: 'VIEW_FINANCE',
        roles: ['FINANCE_OFFICER'],
      },
      {
        label: 'Legacy remittance',
        href: '/remittance',
        icon: ReceiptText,
        help: 'Historical agent remittance balances from the old remit-after-selling model',
        permission: 'VIEW_FINANCE',
        roles: ['FINANCE_OFFICER'],
      },
      {
